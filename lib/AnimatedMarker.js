...
L.AnimatedMarker = L.Marker.extend({
  ...
  initialize: function (latlngs, options) {
  	// dang, the css transition does not seem to work for me -AWW
   ...
   // } else {
      ...
      if (options.maxDuration) {
        this._maxFrames = Math.round(options.maxDuration / this.options.interval); // maximum framerate of 20ms
