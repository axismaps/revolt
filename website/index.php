	...
	<body>
		...
		<div id="content">
			...
			<div class="section">
				...
				<p>Since the Age of Revolution, in the former slave societies of the Atlantic world, black freedom struggles have often been viewed in the terms of ferocious abandon, onslaught, riot, and carnage rather than as organized political movements with identifiable aims, strategies, and tactics...</p>
			</div>
			<div style="clear:both"></div>
			<div class="section">
				<a href="/map/"><img src="images/map.jpg" /></a>
				<h1><a href="/map"><img src="images/arrow.png" />Multi-layered Interactive Map</a></h1>
				<p>Bring the tools of geography and cartography to bear on the understanding of integrated transregional patterns of action by reconsidering the early modern African Diaspora in terms of its military history.</p>
			</div>
			<div style="clear:both"></div>
			<div class="section">
